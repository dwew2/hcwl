...
val=val.substr(0,val.length-2);if(val.length>35){val=val.substr(0,32)+'...'}}
if(activeItems.length==document.getElementById(context._getItemListIdentifier()).querySelectorAll('ul li').length){val='Wedi Dewis Popeth / All Selected'}
